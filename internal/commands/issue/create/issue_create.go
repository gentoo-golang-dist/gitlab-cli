...
func NewCmdCreate(f cmdutils.Factory) *cobra.Command {
	...
	issueCreateCmd.Flags().BoolVarP(&opts.yes, "yes", "y", false, "Don't prompt for confirmation to submit the issue. (default false)")
	issueCreateCmd.Flags().BoolVar(&opts.web, "web", false, "Continue issue creation with web interface. (default false)")
