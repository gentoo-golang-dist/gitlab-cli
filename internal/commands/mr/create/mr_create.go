...
func NewCmdCreate(f cmdutils.Factory) *cobra.Command {
	...
	mrCreateCmd.Flags().StringSliceVarP(&opts.Assignees, "assignee", "a", []string{}, "Assign merge request to people by their `usernames`. Repeat flag for multiple assignees.")
	mrCreateCmd.Flags().StringSliceVarP(&opts.Reviewers, "reviewer", "", []string{}, "Request review from users by their `usernames`. Repeat flag for multiple reviewers.")
