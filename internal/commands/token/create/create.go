...
func NewCmdCreate(f cmdutils.Factory) *cobra.Command {
	...
	cmd.Flags().StringSliceVarP(&opts.scopes, "scope", "S", []string{"read_repository"}, "Scopes for the token. Repeat flag for multiple scopes. For a list, see https://docs.gitlab.com/user/profile/personal_access_tokens/#personal-access-token-scopes.")
