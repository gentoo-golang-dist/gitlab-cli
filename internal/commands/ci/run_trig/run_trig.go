...
func NewCmdRunTrig(f cmdutils.Factory) *cobra.Command {
	...
	pipelineRunCmd.Flags().StringSliceVarP(&envVariables, "variables", "", []string{}, "Pass variables to pipeline in the format <key>:<value>. Repeat flag for multiple variables.")
