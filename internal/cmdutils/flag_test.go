...
func (f *dummyFactory) RepoOverride(repo string) error { return nil }
...
func (f *dummyFactory) BaseRepo() (glrepo.Interface, error) { return nil, nil }

func (f *dummyFactory) Remotes() (glrepo.Remotes, error) { return nil, nil }

func (f *dummyFactory) Config() config.Config { return nil }
