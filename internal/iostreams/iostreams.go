...
func New(options ...IOStreamsOption) *IOStreams {
	...
	// Enable color if the user allows it and at least one output stream is a TTY.
	// Individual call sites, like Color() for StdOut, still gate on the specific stream's TTY.
