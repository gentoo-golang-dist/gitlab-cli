...
1. Install development tools using [mise](https://mise.jdx.dev/):
   ...
   This installs all tools defined in `.tool-versions`: Go, gofumpt, goimports, golangci-lint, markdownlint-cli2, vale, lychee, Node.js, lefthook, and commitlint dependencies.

#### Available hooks

- **pre-commit**: Formats and lints Go code (gofumpt, goimports, golangci-lint), auto-fixes Markdown formatting (markdownlint), reminds you to regenerate docs if command files changed
