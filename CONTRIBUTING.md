...
- **pre-commit**: Formats and lints Go code (golangci-lint with gofumpt/goimports), auto-fixes Markdown formatting (markdownlint), reminds you to regenerate docs if command files changed
