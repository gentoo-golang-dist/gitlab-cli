...
| `FORCE_HYPERLINKS`                           | `display_hyperlinks` | `auto`                                     | Set to `true` (or any truthy value) to force hyperlinks even when not outputting to a TTY. A falsy value falls through to `display_hyperlinks`. |
