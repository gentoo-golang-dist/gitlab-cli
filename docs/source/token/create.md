...
```plaintext
  ...
  -S, --scope strings              Scopes for the token. Repeat flag for multiple scopes. For a list, see https://docs.gitlab.com/user/profile/personal_access_tokens/#personal-access-token-scopes. (default [read_repository])
