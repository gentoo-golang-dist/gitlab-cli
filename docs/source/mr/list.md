...
```plaintext
  ...
  -a, --assignee strings       Get only merge requests assigned to users. Repeat flag for multiple users.
  ...
  -l, --label strings          Filter merge request by label <name>. Repeat flag for multiple labels.
  ...
  -m, --milestone string       Filter merge request by milestone <id>.
      ...
      --not-label strings      Filter merge requests by not having label <name>. Repeat flag for multiple labels.
  ...
  -r, --reviewer strings       Get only merge requests with users as reviewer. Repeat flag for multiple users.
