...
```plaintext
  ...
  -f, --fill                   Do not prompt for title or body, and just use commit info. (default false)
  ...
  -l, --label strings          Add labels.
      --lock-discussion        Lock discussion on merge request. (default false)
  -m, --milestone string       Title of the milestone to assign. Set to "" or 0 to unassign.
  -r, --ready                  Mark merge request as ready to be reviewed and merged. (default false)
      --remove-source-branch   Toggles the removal of the source branch on merge. (default false)
      ...
      --squash-before-merge    Toggles the option to squash commits into a single commit when merging. (default false)
  ...
  -u, --unlabel strings        Remove labels.
      --unlock-discussion      Unlock discussion on merge request. (default false)
      --wip                    Mark merge request as a work in progress. Alternative to --draft. (default false)
