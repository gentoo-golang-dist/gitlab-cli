...
```plaintext
  ...
  -l, --label strings          Filter incident by label <name>. Repeat flag for multiple labels.
  -m, --milestone string       Filter incident by milestone <id>.
      ...
      --not-label strings      Filter incident by lack of label <name>. Repeat flag for multiple labels.
