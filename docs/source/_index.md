...
| `GITLAB_HOST or GL_HOST` | If GitLab Self-Managed or GitLab Dedicated, specify the URL of the GitLab server. (Example: [https://gitlab.example.com](https://gitlab.example.com)) Defaults to [https://gitlab.com.](https://gitlab.com.) |
