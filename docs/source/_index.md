...
| `GLAB_SEND_TELEMETRY` | Set to false to disable telemetry being sent to your GitLab instance. Can be set in the config with 'glab config set telemetry false'. See [Usage statistics](https://docs.gitlab.com/administration/settings/usage_statistics/) for more information |
| `GLAMOUR_STYLE` | The environment variable to set your desired Markdown renderer style. Available options: dark, light, notty. To set a custom style, read [Glamour styles](https://github.com/charmbracelet/glamour#styles) |
