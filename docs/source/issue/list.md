...
```plaintext
  ...
  -l, --label strings          Filter issue by label <name>. Repeat flag for multiple labels.
  -m, --milestone string       Filter issue by milestone <id>.
      ...
      --not-label strings      Filter issue by lack of label <name>. Repeat flag for multiple labels.
