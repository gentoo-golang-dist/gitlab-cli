...
2. On the [**Releases** page for this project](https://gitlab.com/gitlab-org/cli/-/releases), identify the release version you want to publish.
...
5. On GitHub, create a pull request in the `microsoft/winget-pkgs` project. Use the
