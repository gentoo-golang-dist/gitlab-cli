...
### Step 2: Add `--file`, `--line`, `--old-line` flags for diff notes
...
### Step 7: Add `resolve`/`unresolve` subcommands
...
### Step 10: Add `draft` subcommand group
...
### Step 12: Tests for all new commands
