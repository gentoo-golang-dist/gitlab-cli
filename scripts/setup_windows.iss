...
// PathMgr script taken from https://github.com/Bill-Stewart/PathMgr/blob/v2.0.0/PathMan.iss
const
...
[Tasks]
; TODO The following description is not yet translated.
Name: modifypath; Description: "&Add installation path to Windows PATH environment variable"
